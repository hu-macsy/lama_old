...
std::shared_ptr<MatrixStorage<ValueType> > CSRSparseMatrix<ValueType>::createStorage()
{
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const Matrix<ValueType>& other, bool transposeFlag ) : 
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const Matrix<ValueType>& other, DistributionPtr rowDist, DistributionPtr colDist ) : 
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const MatrixStorage<ValueType>& globalData ) : 
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const Expression_SM<ValueType>& expression ) : 
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const Expression_SMM<ValueType>& expression ) : 
...
template<typename ValueType>
CSRSparseMatrix<ValueType>::CSRSparseMatrix( const Expression_SM_SM<ValueType>& expression )
