...
std::shared_ptr<MatrixStorage<ValueType> > ELLSparseMatrix<ValueType>::createStorage()
{
...
template<typename ValueType>
ELLSparseMatrix<ValueType>::ELLSparseMatrix( const Expression_SM_SM<ValueType>& expression )
