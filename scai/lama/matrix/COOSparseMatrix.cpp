...
std::shared_ptr<MatrixStorage<ValueType> > COOSparseMatrix<ValueType>::createStorage()
{
...
template<typename ValueType>
COOSparseMatrix<ValueType>::COOSparseMatrix( const Matrix<ValueType>& other, bool transposeFlag ) : 
...
template<typename ValueType>
COOSparseMatrix<ValueType>::COOSparseMatrix( const Matrix<ValueType>& other, DistributionPtr rowDist, DistributionPtr colDist ) : 
...
template<typename ValueType>
COOSparseMatrix<ValueType>::COOSparseMatrix( const MatrixStorage<ValueType>& globalData ) : 
