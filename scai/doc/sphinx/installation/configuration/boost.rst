...
the location of installation by the variable BOOST_ROOT or by setting an environment variable:: bash
...
Via ccmake you can verify that the Boost variables needed for LAMA have correct values:: bash
...
If you have error message looking like:: bash
