###
 # @file kregistry/examples/run_all.sh
 #
 # @license
 ...
 # @endlicense
 #
 # @brief ToDo: Missing description in ./kregistry/examples/run_all.sh
 # @author Jan Ecker
 # @date 10.02.2016
###
...
echo ""
echo "=========================================================="
echo "==  Building and executing all scai kregistry examples  =="
echo "=========================================================="
echo ""
...
# run examples
RUN 1 BenchInterface.exe
RUN 1 DemoKernelInterface.exe
