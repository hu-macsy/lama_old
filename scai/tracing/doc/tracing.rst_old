...
of the regions and/or for the generation of trace files. 
.. for the generation of Vampir trace files that can be visualized by Vampir.

The tracing framework inside LAMA has been described here: :ref:`SCAI Tracing <scaitracing:main-page_tracing>`.
