 ...
 * @endlicense
 *
 * @brief ParMetisPartitioning.hpp
...
/** ParMetis creates a distribution with load balance in the pieces and less communication volume
 *  for a dedicated sparse matrix.
 *
 *  ParMetisPartitioning is noncopyable as Partitioning is noncopyable
 *
 */

class COMMON_DLL_IMPORTEXPORT ParMetisPartitioning:

    public Partitioning,
    private Partitioning::Register<ParMetisPartitioning>
