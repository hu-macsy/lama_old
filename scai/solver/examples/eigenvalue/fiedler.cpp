...
void makeLaplacian( CSRSparseMatrix<ValueType>& L )
{
    ...
    auto x = denseVector( L.getColDistributionPtr(), ValueType( 1 ) );
...
int main( int argc, const char* argv[] )
{
    ...
    auto u = denseVector<ValueType>( L.getRowDistributionPtr(), 1 ); 
    ...
    auto t = denseVector<ValueType>( L.getRowDistributionPtr(), 1.0 );
