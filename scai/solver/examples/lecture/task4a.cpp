/**
 * @file solver/examples/lecture/task4a.cpp
 *
 * @license
...
int main ( int argc, char* argv[] )
{
    ...
    auto solution = denseVectorFill( dist, ValueType( 1 ) );
    ...
    auto rhs = denseVectorEval( matrix * solution );
    ...
    auto error = denseVectorFill( dist, ValueType( 1 ) );
