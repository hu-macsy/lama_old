...
will be obtained in detail. We close with the general build and install commands. Additionally you can get some tips for
the installation on windows, which is not fully tested yet.
