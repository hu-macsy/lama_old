...
MACRO ( checkFeature FEATURE_NAME FEATURE_NUMBER RESULT_VAR COMPILE_FLAG LINK_LIB )
	...
	IF ( NOT DEFINED ${RESULT_VAR} )
		...
		if    ( "${LINK_LIB}" STREQUAL "" )
			...
			set ( EXTRA_OPTION "-DLINK_LIBRARIES:STRING=${SCAI_START_LINK_LIBRARIES} -l${LINK_LIB} ${SCAI_END_LINK_LIBRARIES}" )
		...
		ELSE ( CROSS_COMPILING )
			...
			#MESSAGE ( STATUS "_RUN_RESULT_VAR ${_RUN_RESULT_VAR}" )
			#MESSAGE ( STATUS "_COMPILE_RESULT_VAR ${_COMPILE_RESULT_VAR}" )
